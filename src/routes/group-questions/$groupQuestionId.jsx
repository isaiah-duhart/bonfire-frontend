...
function GroupQuestionPage() {
    ...
    const { data, isPending, error } = useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await fetch(`${API_URL}/api/group-responses/${groupQuestionId}`, {
                method: 'GET',
    ...
    <>
        ...
        />
        <button onClick={() => queryClient.invalidateQueries({queryKey: ['group-responses']})}>REFRESH</button>
    </>
    )
}
